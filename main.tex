...
% AI-use disclosure lives in the cover letter (submission/cover-letter.md), not in
% the manuscript -- this keeps the blinded review copy free of acknowledgments per
% the submission system's blinding requirement. If the journal wants the disclosure
% in the published version, restore an Acknowledgements section at the camera-ready
% stage.
